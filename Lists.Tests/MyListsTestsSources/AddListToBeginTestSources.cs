...
namespace Lists.Tests.MyListsTestsSources
{
    public class AddListToBeginTestSource : IEnumerable
    {
        public IEnumerator GetEnumerator()
        {
            ...
            MyArrayList expectedList = new MyArrayList(new int[] { 3, 9, 9, 1, 2, 3, 4, 5 });
            ...
            expectedList = new MyArrayList(new int[] {-3, 2 });
            yield return new object[] { list, Addedlist, expectedList };
    ...
    public class AddListToBeginNegativeTestSource : IEnumerable
    {
        public IEnumerator GetEnumerator()
        {
